...
class CoreFollowuser(models.Model):
    user_id = models.IntegerField()
    follow_id = models.IntegerField()
    follow_start_time = models.DateTimeField()

    class Meta:
        managed = False
        db_table = 'core_followuser'


class CoreFriendrequest(models.Model):
...
class CoreUser(models.Model):
    ...
    last_activate_time = models.DateTimeField(blank=True, null=True)
